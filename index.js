...
function displayResults(weather) {
  ...
  relativehumidity_2m = weather.hourly.relativehumidity_2m.slice(
    START_INDEX,
    END_INDEX
  );
...
function findData() {
  ...
  if (longitude && latitude) {
    if (
      ...
      alert(
        "Enter Correct longitude(Betwen -180 and 180) or Latitude (Betwen -90 and 90) values"
      );
    }
  } else {
